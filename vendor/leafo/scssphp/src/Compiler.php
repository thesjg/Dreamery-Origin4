...
//echo 'in t_func: ';
//var_dump($value);
                return $this->reduce($this->fncall($name, $argValues));
        ...
        switch ($value[0]) {
            ...
            case Type::T_KEYWORD:
                ...
                if (isset(Colors::$cssColors[$name])) {
                    ...
                    /* Doesn't accommodate short hex colors */
                    $rgba = array();
                    $rgba[] = hexdec(substr($name, 1, 2));
                    $rgba[] = hexdec(substr($name, 3, 2));
                    $rgba[] = hexdec(substr($name, 5, 2));
                    return [Type::T_COLOR, (int) $rgba[0], (int) $rgba[1], (int) $rgba[2]];
                }
